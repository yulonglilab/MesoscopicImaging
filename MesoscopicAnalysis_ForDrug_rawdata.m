...
ImCorRatioFile = fullfile(MfileDir,'Mesoscopic imaging system setting\CorRatio512pix_20211017.mat'); % Use this calibration file for data between 20211017 and 20220613
...
%                     ImCorRatio = imresize(CorRatio.data(:,:,IdxCamera,IdxLaser),1/ImBinning,'Method','nearest');   % Corresponding camera and laser condition，CorRatio.data
                    ImCorRatio = imresize(CorRatio.data(:,:,IdxCamera,IdxLaser),size(IM1st),'Method','nearest');   % Corresponding camera and laser condition，CorRatio.data
                    tic,
